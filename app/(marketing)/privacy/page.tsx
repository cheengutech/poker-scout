  ...
  return (
    <div className="min-h-screen bg-[#0a0f0a] text-[#e8e0d0]">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-2xl text-[#7ab87a] font-light tracking-wide mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm text-[#8a9a8a] leading-relaxed">
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">2. Information We Collect</h2>

            <h3 className="text-[#6a8a6a] text-xs uppercase tracking-wider mb-2 mt-4">Account Information</h3>
            ...
            <h3 className="text-[#6a8a6a] text-xs uppercase tracking-wider mb-2">SMS Data</h3>
            <p className="mb-3">When you use our SMS service, we collect:</p>
            <ul className="list-disc list-inside space-y-1.5 text-[#6a8a6a] mb-3">
            ...
            <h3 className="text-[#6a8a6a] text-xs uppercase tracking-wider mb-2">Player Notes</h3>
            ...
            <h3 className="text-[#6a8a6a] text-xs uppercase tracking-wider mb-2">Usage Data</h3>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">4. SMS Data Sharing</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">5. Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">7. Your Rights and Choices</h2>
            <ul className="list-disc list-inside space-y-1.5 text-[#6a8a6a]">
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">8. Children&apos;s Privacy</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">9. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">10. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-[#7ab87a] text-sm uppercase tracking-wider mb-3">11. Contact Us</h2>
            <p>If you have questions or concerns about this Privacy Policy or your data, contact us at:</p>
            <p className="text-[#6a8a6a] mt-2">Email: support@poker-scout.com</p>
          </section>
        </div>
      </article>
