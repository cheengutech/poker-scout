    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">3. SMS Service Terms</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">4. Account Registration</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">6. User Content</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">7. AI Processing</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">8. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">9. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">10. Termination</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">11. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-gray-900 text-sm font-semibold uppercase tracking-wider mb-3">12. Contact</h2>
